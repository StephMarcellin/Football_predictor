"""
Bridge pytest → suite Great Expectations pour silver.fbref_keeper.

Ce test ne valide pas de logique Python — silver.fbref_keeper est produit par
...
def test_ge_suite_silver_fbref_keeper():
