"""
Bridge pytest → suite Great Expectations pour intermediate.int_player_zone_season.
...
SUITE_PATH = (
    ...
    / "great_expectations"
    / "intermediate"
    / "int_player_zone_season.yml"
)


def test_ge_suite_intermediate_int_player_zone_season():
