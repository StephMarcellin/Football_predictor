"""
Bridge pytest → suite Great Expectations pour intermediate.int_fbref_schedule.

Ce test ne valide pas de logique Python — int_fbref_schedule est un modèle dbt
...
SUITE_PATH = (
    ...
    / "great_expectations"
    / "intermediate"
    / "int_fbref_schedule.yml"
)


def test_ge_suite_int_fbref_schedule():
