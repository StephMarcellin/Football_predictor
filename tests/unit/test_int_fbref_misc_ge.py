"""
Bridge pytest → suite Great Expectations pour intermediate.int_fbref_misc.

Ce test ne valide pas de logique Python — int_fbref_misc est un modèle dbt
...
def test_ge_suite_int_fbref_misc():
