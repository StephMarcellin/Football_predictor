"""
Bridge pytest → suite Great Expectations pour intermediate.int_fbref_keeper.

Ce test ne valide pas de logique Python — int_fbref_keeper est un modèle dbt
...
SUITE_PATH = (
    ...
    / "great_expectations"
    / "intermediate"
    / "int_fbref_keeper.yml"
)


def test_ge_suite_int_fbref_keeper():
