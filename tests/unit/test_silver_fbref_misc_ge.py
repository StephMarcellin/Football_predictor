"""
Bridge pytest → suite Great Expectations pour silver.fbref_misc.

Ce test ne valide pas de logique Python — silver.fbref_misc est produit par
...
def test_ge_suite_silver_fbref_misc():
