"""
Bridge pytest → suite Great Expectations pour intermediate.player_possession_chains.
...
SUITE_PATH = (
    ...
    / "great_expectations"
    / "intermediate"
    / "player_possession_chains.yml"
)


def test_ge_suite_intermediate_player_possession_chains():
