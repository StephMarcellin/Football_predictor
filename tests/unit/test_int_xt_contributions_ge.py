"""
Bridge pytest → suite Great Expectations pour intermediate.int_xt_contributions.
...
SUITE_PATH = (
    ...
    / "great_expectations"
    / "intermediate"
    / "int_xt_contributions.yml"
)


def test_ge_suite_intermediate_int_xt_contributions():
