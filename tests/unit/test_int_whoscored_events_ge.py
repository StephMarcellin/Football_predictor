"""
Bridge pytest → suite Great Expectations pour intermediate.int_whoscored_events.
...
SUITE_PATH = (
    ...
    / "great_expectations"
    / "intermediate"
    / "int_whoscored_events.yml"
)


def test_ge_suite_intermediate_int_whoscored_events():
